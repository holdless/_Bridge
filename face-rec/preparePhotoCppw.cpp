// preparePhoto.cpp : Defines the entry point for the console application.
//
...
string glasses_cascade_name = "D:/opencv/build/share/OpenCV/haarcascades/haarcascade_eye_tree_eyeglasses.xml";
string eyes_cascade_name = "D:/opencv/build/share/OpenCV/haarcascades/haarcascade_eye.xml";
...
int detectAndDisplay( Mat frame )
{
	...
	//-- Detect faces
	face_cascade.detectMultiScale( frame_gray, faces, 1.05, 2, 0|CV_HAAR_SCALE_IMAGE, Size(200, 200) );
	...
	{	
    	...
    	eyes_cascade.detectMultiScale( faceROI, eyes, 1.05, 2, 0 |CV_HAAR_SCALE_IMAGE, Size(100, 100) );
